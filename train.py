...
def parse_opt():
  ...
  parser.add_argument('--sleep_discriminator_acc',type=float,default=0,help="Determine the accucacy that Discriminator needs to reach out to update the discriminator weights. Only used if 'sleep_discriminator is -1'.")
